...
router.get("/forgot-password", adminController.forgetPass);

router.post("/forgot-password", adminController.forgetPassPost);
...
router.get("/reset-password/:token", adminController.resetPass);

router.post("/reset-password/:token", adminController.resetPassPost);
